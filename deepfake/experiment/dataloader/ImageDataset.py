...
def get_dataset(opt):
    ...
    # train dataset
    train_dataset = ImageDataset(opt.data_path, mode='train', transforms=augmentation)
    train_dataloader = DataLoader(train_dataset, 
                                  batch_size=opt.batch_size, 
                                  shuffle=True, 
                                  num_workers=opt.num_workers)
    # val dataset
    val_dataset = ImageDataset(opt.data_path, mode='val', transforms=augmentation)
    ...
    # test dataset
    test_dataset = ImageDataset(opt.data_path, mode='test', transforms=augmentation)
